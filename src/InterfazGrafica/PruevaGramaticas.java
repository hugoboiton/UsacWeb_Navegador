...
public class PruevaGramaticas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PruevaGramaticas
     */
    public PruevaGramaticas() {
        initComponents();
        /*texto=new PanelTextos();
        texto.setBounds(0, 100,600, 400);
        this.add(texto);
        archivo = new AcccionesArchivos("");*/
        panelcodigo =new PanelCodigo();
        panelcodigo.setBounds(0,100,700,503);
    ...
    private void initComponents() {
        ...
        jButton2.setText("analizar chtml ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        archivo.Abrir(this);
        panelcodigo.texto.Agregartexto(archivo.leerTexto());
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        scannerCHTML scanner=new scannerCHTML(new BufferedReader(new StringReader(panelcodigo.texto.Obtenertexto())));
        scanner.archivo=archivo.getNombreArchivo();
        parserCHTML parser =new parserCHTML(scanner);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PruevaGramaticas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PruevaGramaticas().setVisible(true);
            }
        });
    }
